...
preferences {
    section("CGM Data") {
        ...
        input(name: "CORS", type: "enum", title: "ByPass CORS Check Service", options: ["https://thingproxy.freeboard.io/fetch/","https://api.allorigins.win/raw?url=","https://yacdn.org/serve/"])
    }
...
def getData() {
    ...
    log.debug "SugarThings: Refresh Data from ${CORS} + ${jsonUrl}"
